...
function App() {
  ...
  return (
    <div className="flex h-screen justify-center items-center bg-slate-700">
      <div className="card w-[80%] lg:w-[50%] min-h-[70%] max-h-screen overflow-auto scrollbar-hide shadow-lg rounded-sm transform ease-out duration-300 items-center p-10 gap-5">
